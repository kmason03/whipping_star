...
TAG="Aug14_SignalBox_Script3_FitE_v3"
...
XML="/uboone/app/users/markrl/SBNfit_uBooNE/July2020_SL7/whipping_star/build/bin/FinalSignalBoxUnblinging_Jun2021/XML/Redo/master_mc_final_selection_1g1p_1g0p_2g1p_2g0p_June2021_signal_box_v2.xml"
...
if (! $RUND); then
    ...
    ../$fit_exe -x $XML -t $TAG"_MC_Sensitivity" -m "fit" -c $COV -a "NCDelta,1" &> sensitivity.log
