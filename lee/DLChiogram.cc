...
int main(int argc, char* argv[])
{
  ...
  // Create that data background
  SBNspec noosc(tag+"_Bkg.SBNspec.root",xml);
  SBNspec data("fulldata_CV.SBNspec.root","/uboone/app/users/dcianci/DLLEESensitivity/Thesis2020/whipping_star/xml/dllee_data_jan26.xml");
	...
	std::cout << "chi2 min: " << chi2min << " at dm2: " << dm2min << ", sin22th: " << sin22thmin <<  std::endl;
