...
def main():
    ...
    in_covar_fname   = os.path.join(topdir,"DL_full.SBNcovar_piotest.root")
    detsys_fname     = os.path.join(topdir,"covMat_Enu_Tot_bigbin.csv")
    ...
    offset_1m1p_ext     = 4*Nbins_e+2*Nbins_m
    ...
    out_h0_spec_fname = "katieversion_bigbins_piotest.SBNcovar.root"
    out_covar_fname   = "katieversion_bigbins_piotest.SBNcovar.root"
    ...
    out_covar_collapse = ROOT.TMatrixD( in_covar_f.Get("collapsed_frac_covariance") )
    ...
    #         out_covar[offset_1e1p_nue+i][offset_1e1p_fullosc+j] += detsys_covar_ee[i][j]
    #         out_covar[offset_1e1p_fullosc+j][offset_1e1p_nue+i] += detsys_covar_ee[i][j]
    #
    ...
    #         out_covar[offset_1m1p_bnb+j][offset_1e1p_nue+i] += detsys_covar_em[i][j]
    #         # 1e1p fullosc x 1mu1p bnb
    #         out_covar[offset_1e1p_fullosc+i][offset_1m1p_bnb+j] += detsys_covar_em[i][j]
    #         out_covar[offset_1m1p_bnb+j][offset_1e1p_fullosc+i] += detsys_covar_em[i][j]
    #
    #
    #
    ...
    out_covar_f.WriteTObject(out_covar_collapse, "collapsed_frac_covariance")
    ...
    # out_covar_collapse = collapseFracCovar(out_covar, joint_spec, [(4,22),(3,19)], True)
