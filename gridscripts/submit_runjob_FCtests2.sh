...
#SBATCH --job-name=FCtests2
#SBATCH --output=log-FCtests2
...
singularity exec -B /cluster:/cluster,/cvmfs:/cvmfs ${CONTAINER} bash -c "cd ${SCRIPT_DIR} && source runjob_FCtests2.sh ${TOP_DIR} ${WORK_DIR}"
