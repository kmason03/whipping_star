...
int main(){
	...
	chifile.open("chis_fakedata2.txt", std::ios_base::app);
  ...
  // set1
  // data_v={20,12,6,6,4,5,0,1,0,1,2,1,19,131,205,285,241,318,335,321,234,198,180,158,147,151,124,91,64,38,49};
  // set2
  data_v={4,5,3,2,5,6,1,1,1,3,7,4,24,189,298,342,361,408,471,444,380,311,284,233,194,194,136,122,77,61,55};
  ...
  chifile<<fmin<<" "<<dm2_val<<" "<<ue4_val<<" "<<umu4_val<<std::endl;
	...
	for(int i=0;i<nBins;i++){
		specfile<<(* bestFracSys_collapsed)(i,i)*bestSpec.collapsed_vector[i]*bestSpec.collapsed_vector[i]<<" ";
	}
	specfile<<std::endl;
