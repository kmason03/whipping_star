...
int main(int argc, char* argv[]){
	...
	chifile.open("chis_full_steptest.txt", std::ios_base::app);
	covfile.open("cov_full_total.txt", std::ios_base::app);
	...
	// std::cout<<" cvspec errors"<<std::endl;
	// for (int i =0; i<cvSpec.full_error.size();i++) std::cout<<cvSpec.full_error[i]<<" ";
	// std::cout<<std::endl;
	...
	for(int mi_base = 10; mi_base <11; mi_base++){
		for(int uei_base = 11; uei_base < 12; uei_base++){
			for(int umui_base = 11; umui_base < 12; umui_base++){
				...
				for(int expi = 0; expi < nFakeExp; expi++){
					...
					Double_t ue4_step = 0.1;
					TString ue4_name = "ue4";
					Double_t umu4_step = 0.1;
					...
					std::cout<<chi_pT<<" "<<mnu_base<<" "<<ue_base<<" "<<um_base<<std::endl;
					std::cout<<fmin<<" "<<dm2_val<<" "<<ue4_val<<" "<<umu4_val<<std::endl;
					std::cout<<chi_min_gridc<<" "<<m41_gridc<<" "<<ue_gridc<<" "<<umu4_gridc<<std::endl;
					std::cout<<chi_min_grid<<" "<<m41_grid<<" "<<ue_grid<<" "<<umu4_grid<<std::endl;
...
void printbinedges(){
	...
	for(int mi = 0; mi < 400; mi++){
		mnu = pow(10.,((mi)/float(400)*TMath::Log10(sqrt(dm2_hibound)/sqrt(dm2_lowbound)) + TMath::Log10(sqrt(dm2_lowbound))));
		coordfile << pow(mnu,2) << " ";
	}
	coordfile << std::endl;
