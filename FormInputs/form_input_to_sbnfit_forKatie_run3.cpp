...
int main() {
  ...
  // ... for event lists
  const char* sel_bnb_eventlist_file      = "/uboone/app/users/kmason/SystematicInfo/2021Sep8_fullpi0selection_bnb_overlay_run3.txt";
  const char* sel_bnb_lowE_eventlist_file = "/uboone/app/users/kmason/SystematicInfo/empty.txt";
  const char* sel_nue_eventlist_file      = "/uboone/app/users/kmason/SystematicInfo/2021Sep8_fullpi0selection_nue_intrinsic_run3.txt";
  const char* sel_nue_lowE_eventlist_file = "/uboone/app/users/kmason/SystematicInfo/empty.txt";
  const char* sel_ncpi0_eventlist_file    = "/uboone/app/users/kmason/SystematicInfo/2021Sep8_fullpi0selection_NCPi0_run3.txt";
  const char* sel_ccpi0_eventlist_file    = "/uboone/app/users/kmason/SystematicInfo/2021Sep8_fullpi0selection_CCPi0_run3.txt";
  ...
  // ... for output
  const char* output_file = "/uboone/app/users/kmason/SystematicInfo/input_to_sbnfit_v55_Jun20_withExtraGENIE_pi0_run3_Sep8.root";
