...
int main() {
  ...
  // ... for event lists
  const char* sel_bnb_eventlist_file      = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/sel1e1p_FinalSelection_bnb_run2_events.txt";
  const char* sel_bnb_lowE_eventlist_file = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/empty.txt";
  const char* sel_nue_eventlist_file      = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/sel1e1p_FinalSelection_nue_run2_events.txt";
  const char* sel_nue_lowE_eventlist_file = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/empty.txt";
  const char* sel_ncpi0_eventlist_file    = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/empty.txt";
  const char* sel_ccpi0_eventlist_file    = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/empth.txt";
  const char* sel_dirt_eventlist_file     = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/empty.txt";
  const char* sel_extbnb_eventlist_file   = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/empty.txt";
  const char* sel_fullosc_eventlist_file   = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/sel1e1p_FinalSelection_fullosc_run2_events.txt";
  // ... for data event list
  ...
  const char* fullosc_arborist_file     = "/uboone/data/users/kmason/arborist/arborist_v48_Sep24_withExtraGENIE_fullosc_nue_run2.root";
  ...
  // ... for output
  const char* output_file = "/uboone/app/users/kmason/LaurenVersion/form_input_to_sbnfit/input_to_sbnfit_v55_Oct15_withExtraGENIE_1e1p_FinalSelection_run2.root";
