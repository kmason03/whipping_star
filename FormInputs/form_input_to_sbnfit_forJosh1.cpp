...
int main() {
  ...
  // ... for event lists
  const char* sel_bnb_eventlist_file      = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/sel1mu1p_bnb_run1_eventlist.txt";
  const char* sel_bnb_lowE_eventlist_file = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/empty.txt";
  const char* sel_nue_eventlist_file      = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/sel1mu1p_nue_run1_eventlist.txt";
  const char* sel_nue_lowE_eventlist_file = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/empty.txt";
  const char* sel_ncpi0_eventlist_file    = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/sel1mu1p_ncpi0_run1_eventlist.txt";
  const char* sel_ccpi0_eventlist_file    = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/sel1mu1p_ccpi0_run1_eventlist.txt";
  const char* sel_dirt_eventlist_file     = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/empty.txt";
  const char* sel_extbnb_eventlist_file   = "/uboone/app/users/yatesla/othersys_mcc9/input_to_sbnfit/sel1mu1p_extbnb_run1_eventlist.txt";
  // ... for data event list
  ...
  // ... for output
  const char* output_file = "/uboone/app/users/jmills/form_input_to_sbnfit/src/outputs_for_numudis/input_to_sbnfit_v55_Nov15_withExtraGENIE_1mu1p_run1_Aug06.root";
